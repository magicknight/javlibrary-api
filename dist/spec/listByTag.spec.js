...
describe('listByTag', function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return jav.listByTag({ id: 'ae' });

                    case 2:
                        results = _context.sent;
                        valid = ajv.validate('listByTag', results);
    ...
    it('list all video by tag without next page', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var results, valid;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.next = 2;
                        return jav.listByTag({ id: 'ae', page: 99 });
