...
import { URL_LISTBYDIRECTOR, parseList } from '../utils/helper';
 ...
 * */
const listByDirector = async({ id, page = 1 } = {}) => {
    try {
        var request = createRequest();
        var response = await request.get(`${URL_LISTBYDIRECTOR}${id}&page=${page}`);
